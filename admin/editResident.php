...
<html lang="en">
    ...
    <body>
        ...
        if(isset($_GET['id'])){
            $residentid=$_GET['id'];
            $q1="SELECT * FROM resident WHERE resident.id='$residentid'";
            ...
            <input type="hidden" name="id" value="<?= $q1['id']; ?>" class="form-control">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="room_no" value="<?= $q1['room_no']; ?>" oninput="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="1" class="form-control" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <button type="submit"  name="update" class="btn btn-success">Update User</button>
                    <td><a href="manageT.php" onclick="return confirm('Are you sure to leave this page? Progress would not be saved. ')" class="btn btn-danger">Cancel</a></td>
                    </div>
